...
two (D and A)detectors (D and A)four basic photon streams: 
...
As in ALEX, the two alternation here are four basic PAX photon streams are analogous to the ALEX ones
