...
\[
S_{\gamma\beta} = \frac{F_{DexAem} + \gamma F_{DexDem}}{F_{DexAem} + \gamma F_{DexDem} + F_{AexAem}/\beta}
\label{eq:Sgb}
\]
...
\[
S_{\gamma\beta,PAX} = \frac{F_{FRET} + \gamma\,(F_{DexDem} + F_{AexDem})}
{F_{DexAem} + \gamma\,(F_{DexDem} + F_{AexDem}) + \tilde{F}_{AexAem}/\beta}
\label{eq:Sgb}
\]