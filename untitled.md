...
Single-molecule FRET periodic acceptor excitation (smFRET-PAX) \cite{Doose_2007} is a technique closely realted to smFRET-μsALEX where one laser is constantly ONonly the second laser is alternated. In both cases measurements using two lasers to excite freely-diffusing molecules, the
