In solution-based single-molecule FRET
experiments, single-molecule FRET microsecond alternated excitation (smFRET-μsALEX)\cite{Lee_2005} is among the. In smFRET-μsALEX two exciting lasers are alternated with a
